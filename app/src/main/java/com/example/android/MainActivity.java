...
public class MainActivity extends AppCompatActivity {
    private final LinkedList<String> mRestroomList = new LinkedList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRestroomList.addLast("Fruit Pizza");
        ...
        mRestroomList.addLast("The Best Soft Chocolate Chip Cookies");
        ...
        mRestroomList.addLast("Blender Lemon Pie");
        ...
        mRestroomList.addLast("Modern Scotcheroos");
        ...
        mRestroomList.addLast("Raspberry Crumble Bars");
        ...
        mRestroomList.addLast("Mind-Blowing Vegan Chocolate Pie");
        ...
        mRestroomList.addLast("Gooey Caramel Monkey Bread");
        ...
        mRestroomList.addLast("Raw Salted Chocolate Snack Bars");
        ...
        mRestroomList.addLast("Carrot Cake Coffee Cake");
        ...
        mRestroomList.addLast("Salted Caramel Brownies");
        ...
        mAdapter = new RestroomListAdapter(this, mRestroomList, mDescriptionList);
